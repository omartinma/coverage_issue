...
dart run utils/tool/ci_generate_fast_coverage_test.dart 

rm -rf coverage
if grep -q "flutter:" pubspec.yaml; then
    flutter --version
    flutter test utils/tool/generated_fast_coverage_test.dart --no-pub --test-randomize-ordering-seed random --coverage
else
    dart --version
